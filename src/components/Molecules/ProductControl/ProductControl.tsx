...
const ProductControl = ({ price, disabledRemove, hiddenRemoveButton, handleAddProduct }: IProductControl) => {
  return (
    <div className="flex">
      ...
      <Button content="+" onClick={handleAddProduct} className="text-sm font-medium text-right" />
    </div>
  )
}
